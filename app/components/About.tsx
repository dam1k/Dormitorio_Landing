...
function About() {
  ...
  if (domLoaded) {
    return (
      ...
      >
        <p className="max-w-[1200px] min-[1025px]:mb-[100px] px-[15px] max-[1024px]:mb-[0] max-[1024px]:mt-[75px] text-[18px] text-center">
